...
def kafka_prod():
    ...
    for data in data_list:
        #print(data)
        producer.send('ServiceArea1', data.encode('utf-8'))
    producer.flush()
...
def spark_kafka():
    ...
    in_value_df = spark.sql("select * from ServiceArea")
    ...
    df_ins.write.format("com.mongodb.spark.sql.DefaultSource") \
        ...
        .option('uri', "mongodb://127.0.0.1/CDW_SAPP.ServiceArea") \
        .save()
def main():
    kafka_prod()
    spark_kafka()
